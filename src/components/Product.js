...
const Product = ({ post }) => {
  ...
  return (
    ...
    hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]"
    >
      <div className="">
      ...
      <div className="h-[180px]">
        <img src={post.image} className="h-full w-full" alt="images" />
      </div>
